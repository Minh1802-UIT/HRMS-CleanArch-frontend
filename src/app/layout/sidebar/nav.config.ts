    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Face Register',   icon: 'face',            route: '/attendance/face-register',   activePage: 'face-register' },
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Offices',       icon: 'location_on', route: '/attendance/offices',           activePage: 'office-management', roles: ['Admin', 'HR'] },
          { label: 'Face Approval', icon: 'how_to_reg',  route: '/attendance/face-approval',     activePage: 'face-approval',     roles: ['Admin', 'HR'] },
...
export const ROUTE_MAP: Record<string, string> = {
  ...
  'office-management': '/attendance/offices',
  'face-register': '/attendance/face-register',
  'face-approval': '/attendance/face-approval',
  leaves: '/leaves',
  approvals: '/approvals',
